...
const Product = () => {
  ...
  const props = {
    width: 500,
    zoomWidth: 500,
    zoomStyle: "opacity: 0.9",
    zoomPosition: "original",
    img: "https://www.movado.com/dw/image/v2/BDKZ_PRD/on/demandware.static/-/Sites-mgi-master/default/dwcdf1f552/images/products/3640002w_LRG_rgb_Web.png?sw=1660&sh=1660",
  };
        ...
        <div className="row">
          <div className="col-6">
            ...
            <div className="secondary-product-image d-flex flex-wrap gap-15">
              <div>
                <img
                  src="https://www.movado.com/dw/image/v2/BDKZ_PRD/on/demandware.static/-/Sites-mgi-master/default/dwcdf1f552/images/products/3640002w_LRG_rgb_Web.png?sw=1660&sh=1660"
                  className="img-fluid"
                  alt=""
                />
              </div>
          ...
          <div className="col-6">
            <div className="main-product-details">
              <div className="border-btm">
                <h3 className="title">
                  Mavado Watch for Men, Luxury Timepiece
                </h3>
              </div>
              ...
              <div className="border-btm py-3">
                ...
                <div className="d-flex gap-15 flex-row align-items-center mt-2 mb-3">
                  ...
                  <div className="d-flex align-items-center gap-30 ms-5">
                    <Link to="/cart" className="button border-0">
                      Add To Cart
                    </Link>
                ...
                <div className="d-flex gap-15 align-items-center">
                  ...
                  <div>
                    <a href="" className="detail-link">
                      <GoChecklist className="fs-5 me-2" />
                      Add to Wishlist
                    </a>
                  </div>
                </div>
                <div className="d-flex gap-10 align-items-center my-2">
                  ...
                  <p className="product-data">
                    ...
                    Please allow <b>5-10 business days</b> for your order
                  </p>
                </div>
          ...
          <div className="col-12">
            ...
            <div className="p-3 bg-white">
              <p>
                ...
                arcu quis dolor rutrum ultrices.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="review">
                  <div className="d-flex gap-10 align-items-center">
                    <div>
                      ...
                      <p className="mt-3">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Suspendisse iaculis, neque sit amet lacinia suscipit,
                      </p>
                    </div>
                  </div>
                </div>
