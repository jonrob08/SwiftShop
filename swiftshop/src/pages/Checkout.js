        ...
        <div className="checkout-wrapper py-5">
            <div className="container-xxl">
                <div className="row">
                    ...
                    <div className="col-5">
                        <div className='border-btm py-4'>
                            <div className="d-flex gap-10 mb-2 align-items-center">
                                <div className='w-75 d-flex gap-10'>
                                    <div className='w-25 position-relative'>
                                    <span style={{ top: "-10px", right: "2px" }} className="badge bg-secondary text-white rounded-circle p-3 position-absolute">1</span>
                                        <img className='img-fluid' src={Watch} alt="" />
                                    </div>
                                    <div>
                                        <h5 className="total-price">Product Title</h5>
                                        <p className='"total-price"'>SKU #: 19387589</p>
                                    </div>
                                </div>
                                <div className='flex-grow-1'>
                        ...
                        <div className='d-flex justify-content-between align-items-center border-btm py-4'>
