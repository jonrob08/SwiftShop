          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                ...
                <a
                  href="tel:+1 7175929969"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +1 (717) 592-9969
                </a>
                <a
                  href="mailto:jonrob08@gmail.com"
            ...
            <div className="col-3">
              ...
              <div className="footer-links d-flex flex-column">
                <Link to="/privacy-policy" className="mb-1 py-2 text-white">
                  Privacy Policy
                </Link>
                <Link to="/refund-policy" className="mb-1 py-2 text-white">
                  Refund Policy
                </Link>
                <Link to="/shipping-policy" className="mb-1 py-2 text-white">
                  Shipping Policy
                </Link>
                <Link to="/tandc" className="mb-1 py-2 text-white">
                  Terms & Conditions
                </Link>
                <Link to="/blog" className="mb-1 py-2 text-white">
                  Blog
                </Link>
              </div>
            </div>
            <div className="col-3">
              ...
              <div className="footer-links d-flex flex-column">
                ...
                <Link to="/contact" className="mb-1 py-2 text-white">
                  Contact
                </Link>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}, SwiftShop Powered by JonRob
                Technologies
              </p>
            </div>
          </div>
